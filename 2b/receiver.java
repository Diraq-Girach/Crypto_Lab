...
public class receiver {
    ...
    public static int[] decryptBlock(int[] ciphertext, int[] key, boolean showSteps) {
        if (showSteps) {
            System.out.println("\n=== DECRYPTION PROCESS ===");
        }
        ...
        for (int round = 15; round >= 0; round--) {
            ...
            if (showSteps) {
                ...
                System.out.println("After Round " + (16 - round) + ": " + binaryToHex(combined));
            }
        }
        ...
        if (showSteps) {
            System.out.println("\nAfter FP: " + binaryToHex(plaintext));
        }
        return plaintext;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String ciphertextString = input.readUTF();
            
            System.out.println("Complete ciphertext received (String): " + ciphertextString);
            System.out.println("Length: " + ciphertextString.length() + " characters");
            
            System.out.println("\nEnter the secret key for decryption (8 characters):");
            ...
            int numBlocks = ciphertextString.length() / 8;
            ...
            for (int blockIndex = 0; blockIndex < numBlocks; blockIndex++) {
                String block = ciphertextString.substring(blockIndex * 8, (blockIndex + 1) * 8);
                
                
                System.out.println("PROCESSING BLOCK " + (blockIndex + 1) + " of " + numBlocks);
                
                System.out.println("Block (String): " + block);
                
                int[] ciphertext = textToBinary(block);
                System.out.println("Block (Hex): " + binaryToHex(ciphertext));
                
                
                int[] decrypted = decryptBlock(ciphertext, key,true);
                
                String decryptedText = binaryToText(decrypted);
                completePlaintext.append(decryptedText);
            ...
            System.out.println("FINAL DECRYPTION RESULT");
            
            System.out.println("Complete Plaintext: " + completePlaintext.toString());
            System.out.println("Length: " + completePlaintext.length() + " characters");
