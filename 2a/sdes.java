...
public class sdes {
    ...
    // on other implementations i noticed for k2 the origibal split is shifted twice 
    // however, in the implementation i have followed the class notes and shifted that already shifted 2 halves for k1 again by 2 
    ...
    public static void main(String[] args) {
        // Example: 8-bit plaintext and 10-bit key
        ...
        System.out.println("\nFinal Result");
        printBinary("Ciphertext", ciphertext);
